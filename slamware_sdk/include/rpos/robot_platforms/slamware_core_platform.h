...
#include <rpos/robot_platforms/objects/diagnosis_subscribe_provider.h>
...
namespace rpos { namespace robot_platforms {
    ...
    public:
        ...
        std::vector<rpos::core::KeyFramePose> getKeyFramePoses(const int& num);
        ...
        bool setMapLoopClosureArea(const core::RectangleF& area);
    ...
    public:
        ...
        actions::MoveAction moveToTag(const rpos::core::Pose& dockingPose, const features::motion_planner::MoveToTagOptions& options);
    ...
    public:
        ...
        features::system_resource::LaserScan getRawLaserScan();
        ...
        bool setAEBControl(rpos::core::AEBControlCmd aebControlCmd);
    ...
    public:
        ...
        boost::shared_ptr<robot_platforms::objects::DiagnosisSubscribeProvider<SubType>> createDiagnosisSubscribeProvider(const std::string& topic, int timeoutInSeconds = 30);
