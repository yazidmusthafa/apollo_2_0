...
namespace rpos { namespace system { namespace serialization { namespace json {
    ...
    template <class T>
    boost::optional<Json::Value> try_serialize(const T& v)
    {
        try
        {
            return boost::optional<Json::Value>(serialize<T>(v));
        }
        catch (...)
        {
    ...
    template <class T>
    boost::optional<T> try_deserialize(const Json::Value& v)
    {
        try
        {
            return boost::optional<T>(deserialize<T>(v));
        }
        catch (...)
        {
