...
namespace rpos { namespace system { namespace serialization { namespace json {
    ...
    template <>
    struct RPOS_CORE_API Serializer < core::Point >
    {
        static Json::Value serialize(const core::Point& v);
        static core::Point deserialize(const Json::Value& v);
    };
    ...
    template <>
    struct RPOS_CORE_API Serializer < core::Quaternion >
    {
        static Json::Value serialize(const core::Quaternion& v);
        static core::Quaternion deserialize(const Json::Value& v);
    };
    ...
    template <>
    struct RPOS_CORE_API Serializer < core::RectangleI >
    {
    ...
    template <>
    struct RPOS_CORE_API Serializer < core::ORectangleF >
    {
    ...
    template <>
    struct RPOS_CORE_API Serializer < core::Imu >
    {
        static Json::Value serialize(const core::Imu& v);
        static core::Imu deserialize(const Json::Value& v);
    };
    ...
    template <>
    struct RPOS_CORE_API Serializer < core::DiagnosisInfoMapDiscrepancy >
    {
        static Json::Value serialize(const core::DiagnosisInfoMapDiscrepancy& v);
        static core::DiagnosisInfoMapDiscrepancy deserialize(const Json::Value& v);
    };
    ...
    template <>
    struct RPOS_CORE_API Serializer < core::SetChargeControl > {
        static Json::Value serialize(const core::SetChargeControl& tVal);
        static core::SetChargeControl deserialize(const Json::Value& jsnVal);
    };

    template <>
    struct RPOS_CORE_API Serializer < core::GetChargeControlStatus > {
        static Json::Value serialize(const core::GetChargeControlStatus& tVal);
        static core::GetChargeControlStatus deserialize(const Json::Value& jsnVal);
    };
    
    template <>
    struct RPOS_CORE_API Serializer < core::ImuTreshTestData > {
        static Json::Value serialize(const core::ImuTreshTestData& tVal);
        static core::ImuTreshTestData deserialize(const Json::Value& jsnVal);
    };

    template <>
    struct RPOS_CORE_API Serializer < core::IMURawADCData > {
        static Json::Value serialize(const core::IMURawADCData& tVal);
        static core::IMURawADCData deserialize(const Json::Value& jsnVal);
    };

    template <>
    struct RPOS_CORE_API Serializer < core::IMURawStandardUnitData > {
        static Json::Value serialize(const core::IMURawStandardUnitData& tVal);
        static core::IMURawStandardUnitData deserialize(const Json::Value& jsnVal);
    };

    template <>
    struct RPOS_CORE_API Serializer < core::LightChannel > {
        static Json::Value serialize(const core::LightChannel& tVal);
        static core::LightChannel deserialize(const Json::Value& jsnVal);
    };

    template <>
    struct RPOS_CORE_API Serializer < core::LightControlPart > {
        static Json::Value serialize(const core::LightControlPart& tVal);
        static core::LightControlPart deserialize(const Json::Value& jsnVal);
    };

    template <>
    struct RPOS_CORE_API Serializer < core::LightControlMode > {
        static Json::Value serialize(const core::LightControlMode& tVal);
        static core::LightControlMode deserialize(const Json::Value& jsnVal);
    };

    template <>
    struct RPOS_CORE_API Serializer < core::LightColor > {
        static Json::Value serialize(const core::LightColor& tVal);
        static core::LightColor deserialize(const Json::Value& jsnVal);
    };

    template <>
    struct RPOS_CORE_API Serializer < core::LightControlData > {
        static Json::Value serialize(const core::LightControlData& tVal);
        static core::LightControlData deserialize(const Json::Value& jsnVal);
    };

    template <>
    struct RPOS_CORE_API Serializer < core::AEBControlCmd > {
        static Json::Value serialize(const core::AEBControlCmd& tVal);
        static core::AEBControlCmd deserialize(const Json::Value& jsnVal);
    };
