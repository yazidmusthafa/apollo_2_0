                ...
                private:
                    ...
                    void doTransmit_()
                    {
                        socket_.async_write_some(
                            ...
                            boost::bind(&TcpConnection::onTransmitComplete_, this->shared_from_this(), 
                ...
                private:
                    ...
                    void receive_()
                    {
                        socket_.async_read_some(
                            ...
                            boost::bind(&TcpConnection::onReceiveComplete_, this->shared_from_this(), 
                                boost::placeholders::_1, boost::placeholders::_2)
                            );
            ...
            private:
                void startAccept_()
                {
                    ...
                    acceptor_.async_accept(connection->socket(),
                        boost::bind(&TcpServer::handleConnection_, this, connection, boost::placeholders::_1));
                    startWorker_();
                }
