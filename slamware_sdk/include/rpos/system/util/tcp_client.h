    ...
    public:
        bool connect(const std::string& host, int port)
        {
            ...
            resolver_.async_resolve(query, 
                boost::bind(&TcpClient::onAddressResolved_, this->shared_from_this(), boost::placeholders::_1, boost::placeholders::_2));
    ...
    private:
        ...
        void connect_()
        {
            ...
            socket_.async_connect(endpoint, 
                boost::bind(&TcpClient::onConnect_, this->shared_from_this(), boost::placeholders::_1));
        }
    ...
    private:
        ...
        void doTransmit_()
        {
            socket_.async_write_some(
                ...
                boost::bind(&TcpClient::onTransmitComplete_, this->shared_from_this(),
    ...
    private:
        ...
        void receive_()
        {
            socket_.async_read_some(
                ...
                boost::bind(&TcpClient::onReceiveComplete_, this->shared_from_this(), 
                    boost::placeholders::_1, boost::placeholders::_2)
                );
        }
